...
/*
	Stored Procedure atau SP atau PROCEDURE adalah sekolompok Transact-SQL yang membentuk serangkaian logika
	atau prosedure yang disimpakn ke dalam database sebagai object.
...
--Pemberian tanda N digunakan untuk unicode declaration, apabila paramaternya memiliki tipe Nvarchar dan kalian ingin memasukan unicode character, harus memakai N di depan string.
